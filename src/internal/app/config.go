...
func LoadConfig() Config {
	...
	cfg := Config{
		...
		WebAuthnAttestation:    getEnv("WEBAUTHN_ATTESTATION_CONVEYANCE", "none"),
		WebAuthnAllowedAAGUIDs: getListEnv("WEBAUTHN_ALLOWED_AAGUIDS"),
